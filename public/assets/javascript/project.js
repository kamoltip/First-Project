$(document).ready(function() {
  ...
  function getYouTube(datatopic) {
    ...
    var queryURL = 'https://www.googleapis.com/youtube/v3/search?maxResults=9&part=snippet&&relevanceLanguage=en&q=' +
      ...
      '&type=video&videoEmbeddable=true&key=AIzaSyAdRit-J3O3HY3ojccN4WDrf1Zqa-mVcgw';
  ...
  function getNews(datatopic) {
    ...
    var searchTopic = datatopic.split(" ").join("+");
    var endpoint = 'https://api.nytimes.com/svc/search/v2/articlesearch.json?q=' + searchTopic + '&sort=newest&begin_date=20170101&hl=true&api_key=6c06af0cde254bc0a14d82aaa261021c';
